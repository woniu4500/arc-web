 ...
 * 
 */
package com.li.arcweb.common.web.util;
...
public final class WebDateUtil {
	...
	/**
	 * yyyyMMddHHmmss转化为yyyy-mm-ddT00:00:00
	 *
	 * @param date the date
	 * @return the string
	 */
	public static String string2datetime(String datetime) {
		if (datetime == null || datetime.length() != NUM_14){
			return null;
		}
		return datetime.substring(0, NUM_4) + "-" +  datetime.substring(NUM_4, NUM_6) + "-" + datetime.substring(NUM_6, NUM_8)
				+" "+datetime.substring(8, 10)+":"+datetime.substring(11, 12)+":"+datetime.substring(12, 14);
	}
	...
	public static void main(String [] args){
		System.out.println(string2datetime("20160405000000"));
	}
}
