package com.li.arcweb.common.encode;
 ...
 * 
 */
public abstract class DES4WebUser {

	private static final Logger LOG = LoggerFactory.getLogger(DES4WebUser.class);
	/** DES Key */
	private static final String KEY = "honghao20140x00";
